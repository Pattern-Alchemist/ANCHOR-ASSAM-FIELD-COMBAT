...
export const COMBAT_COURSES: CombatCourse[] = [
  {
    ...
    difficulty: "Advanced",
    videos: [
      { id: "bm-1", title: "Machete Fundamental Cuts", duration: "5 min", description: "Basic 5-angle striking system.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "bm-2", title: "Advanced Blade Combinations", duration: "7 min", description: "Flowing between angles.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "bm-1" },
      { id: "bm-3", title: "Defensive Blade Techniques", duration: "6 min", description: "Parries and counters.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "bm-2" },
      { id: "bm-4", title: "Weapon Speed & Precision Training", duration: "8 min", description: "Targeting drills.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "bm-3" },
      { id: "bm-5", title: "Blade Maintenance & Combat Readiness", duration: "4 min", description: "Field sharpening.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "bm-4" }
    ]
  },
  {
    id: "lone-soldier",
    ...
    videos: [
      { id: "ls-1", title: "Situational Awareness for Solo Combat", duration: "7 min", description: "Scanning and threat detection.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "ls-2", title: "De-escalation & Combat Decision Making", duration: "6 min", description: "When to fight, when to move.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ls-1" },
      { id: "ls-3", title: "Pressure Testing Under Stress", duration: "8 min", description: "Mental fortitude drills.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ls-2" },
      { id: "ls-4", title: "Multi-Opponent Scenario Training", duration: "9 min", description: "Managing multiple threats.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ls-3" },
      { id: "ls-5", title: "Weapon Transitions in Combat", duration: "7 min", description: "Switching between tools.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ls-4" },
      { id: "ls-6", title: "Combat Endurance & Mental Toughness", duration: "8 min", description: "Pushing past the limit.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ls-5" }
    ]
  },
  {
    id: "muay-thai-engine",
    ...
    difficulty: "Advanced",
    videos: [
      { id: "mt-1", title: "Clinch Dominance Techniques", duration: "8 min", description: "Controlling the inside space.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "mt-2", title: "Explosive Combo Chains", duration: "7 min", description: "Linking strikes for maximum impact.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "mt-1" },
      { id: "mt-3", title: "Movement & Distance Management", duration: "6 min", description: "Controlling the range.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "mt-2" },
      { id: "mt-4", title: "Combat Pressure Application", duration: "8 min", description: "Applying relentless pressure.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "mt-3" }
    ]
  },
  {
    id: "land-warfare",
    ...
    difficulty: "Intermediate",
    videos: [
      { id: "lw-1", title: "Terrain Utilization in Combat", duration: "6 min", description: "Cover and concealment.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "lw-2", title: "Ground Movement & Positioning", duration: "7 min", description: "Low crawl and stealth movement.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "lw-1" },
      { id: "lw-3", title: "Climbing Under Combat Load", duration: "5 min", description: "Ascending with gear.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "lw-2" },
      { id: "lw-4", title: "Environment Weapons", duration: "6 min", description: "Improvising from nature.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "lw-3" },
      { id: "lw-5", title: "Survival Combat Integration", duration: "7 min", description: "Merging combat and survival.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "lw-4" }
    ]
  },
  {
    ...
    difficulty: "Advanced",
    videos: [
      { id: "cc-1", title: "Explosive Power Development", duration: "7 min", description: "Plyometrics for combat.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "cc-2", title: "Combat Cardio (High-Intensity Protocols)", duration: "8 min", description: "Tabata and interval training.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "cc-1" },
      { id: "cc-3", title: "Grip & Weapon Endurance", duration: "6 min", description: "Forearm and hand strength.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "cc-2" },
      { id: "cc-4", title: "Mental Fortitude Training", duration: "7 min", description: "Breathwork under fatigue.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "cc-3" }
    ]
  },
  {
    id: "unarmed-defense",
    ...
    difficulty: "Intermediate",
    videos: [
      { id: "ud-1", title: "Vulnerability Awareness", duration: "6 min", description: "Identifying weak points.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
      { id: "ud-2", title: "Evasive Footwork", duration: "7 min", description: "Creating distance and angles.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ud-1" },
      { id: "ud-3", title: "Counter-Striking Basics", duration: "8 min", description: "Turning defense into offense.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ud-2" },
      { id: "ud-4", title: "Escaping the Clinch", duration: "6 min", description: "Breaking contact safely.", url: "https://www.youtube.com/embed/dQw4w9WgXcQ", prerequisite: "ud-3" }
    ]
  }
];
